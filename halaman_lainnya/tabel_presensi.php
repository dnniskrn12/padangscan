<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-12">
                <h1>Tabel Presensi Karyawan Bulan <?= MONTH_IN_INDONESIA[Date('m') - 1]; ?> <?= Date("Y"); ?></h1>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="card">
        <div class="card-body">
            <table class="table table-bordered table-hover">
                <thead>
                    <tr>
                        <th class="text-center align-middle" rowspan="2">Nomor Karyawan</th>
                ...
                <tbody>
                    <?php foreach ($pegawai as $value) : ?>
                        <tr>
                            <td class="text-center td-fit" style="vertical-align: middle;"><?= $value['no_karyawan'] ?></td>
