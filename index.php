...
if (isset($_SESSION['user'])) {
                ...
                case "admin":
                    if (isset($_GET['method'])) {
                        if ($_GET['method'] === 'tambah')
                            include_once "halaman_tambah_data/admin.php";
                        elseif ($_GET['method'] === 'edit')
                            include_once "halaman_edit_data/admin.php";
                        elseif ($_GET['method'] === 'hapus')
                            include_once "halaman_hapus_data/admin.php";
                    } else
                        include_once "halaman_tampil_data/admin.php";
                    break;
                case "cabang":
                    if (isset($_GET['method'])) {
                        if ($_GET['method'] === 'tambah')
                            include_once "halaman_tambah_data/cabang.php";
                        elseif ($_GET['method'] === 'edit')
                            include_once "halaman_edit_data/cabang.php";
                        elseif ($_GET['method'] === 'hapus')
                            include_once "halaman_hapus_data/cabang.php";
                    } else
                        include_once "halaman_tampil_data/cabang.php";
                    break;
                case "pegawai":
                    if (isset($_GET['method'])) {
                        if ($_GET['method'] === 'tambah')
    ...
    echo "<script>window.location.href = 'halaman_auth/login.php';</script>";
