...
if (isset($_POST['submit'])) {
    ...
    try {
        ...
        $mysqli->commit();
        echo "<script>alert('Berhasil memperbaharui data karyawan');</script>";
        echo "<script>window.location.href = '?page=" . $_GET['page'] . "';</script>";
    } catch (\Throwable $e) {
        $mysqli->rollback();
        throw $e;
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="no_karyawan" id="no_karyawan" value="<?= $data['no_karyawan']; ?>"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nomor_telepon" name="nomor_telepon" required
                                    autocomplete="off" value="<?= $data['nomor_telepon']; ?>">
                            </div>
                            <div class="form-group">
                                <label for="tanggal_lahir">Tanggal Lahir</label>
                                <input type="date" class="form-control" name="tanggal_lahir" id="tanggal_lahir"
                                    value="<?= $data['tanggal_lahir']; ?>" required autocomplete="off">
                            </div>
                            <div class="form-group">
                                <label for="tempat_lahir">Tempat Lahir</label>
                                <input type="text" class="form-control" id="tempat_lahir" name="tempat_lahir"
                                    value="<?= $data['tempat_lahir']; ?>" required autocomplete="off">
                            </div>
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <div class="custom-file">
                                        ...
                                        <label class="custom-file-label" for="gambar">Pilih gambar baru untuk
                                            memperbaharui</label>
                                    </div>
                                </div>
                            </div>
