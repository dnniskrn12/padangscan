                    ...
                    <div class="card card-primary">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="no_karyawan" disabled>
                            </div>
                            <div class="form-group">
                                <label>Cabang</label>
...
<script>
    document.querySelector("select[name=id_pegawai]").addEventListener('change', function() {
        document.querySelector("input[name=no_karyawan]").value = this[this.selectedIndex].getAttribute('data-nip');
